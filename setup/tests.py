...
class AnimaisTestCase(LiveServerTestCase):
    ...
    def setUp(self):
        self.browser = webdriver.Chrome('D:\Cursos\Django alura\TDD_busca_animal\chromedriver.exe')
    ...
    def test_buscando_um_novo_animal(self):
        ...
        caracteriticas = self.browser.find_elements(By.CSS_SELECTOR, '.result-description')
        self.assertGreater(len(caracteriticas), 3)
